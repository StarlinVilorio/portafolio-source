...
export function ScrollJourney(){
 ...
 return <div className="scroll-journey" id="journey">
  <div className="journey-stage" aria-hidden="true"><JourneyScene/><div className="journey-vignette"/><div className="journey-coordinate">STARLIN / {en?'A WORK IN MOTION':'IDEAS EN MOVIMIENTO'}</div><div className="journey-progress"><span/></div></div>
  <div className="journey-chapters">
   ...
   <section className="journey-chapter chapter-left" id="discover-me" data-chapter="1">
    <div className="chapter-inner shell">
     ...
     <figure className="journey-portrait"><Image src="/hero.webp" alt="Starlin Vilorio" fill sizes="(max-width:720px) 65vw, 30vw"/><figcaption>{en?'Based in the Dominican Republic. Connected to the world.':'Desde República Dominicana. Conectado con el mundo.'}</figcaption></figure>
    </div>
   </section>
