...
export const metadata: Metadata = { metadataBase: new URL('https://starlinit.com'), title, description, authors: [{ name: 'Starlin Vilorio' }], alternates: { canonical: '/' }, keywords: ['Starlin Vilorio', 'StarlinIT', 'soporte técnico', 'administración de sistemas', 'desarrollo web', 'inteligencia artificial', 'Coral Better Graphic', 'República Dominicana'], openGraph: { title, description, url: 'https://starlinit.com', type: 'website', locale: 'es_DO' }, twitter: { card: 'summary_large_image', title, description } };
export default function RootLayout({ children }: Readonly<{
    children: React.ReactNode;
}>) { return <html lang="es" className={poppins.variable}><body>{children}{process.env.NODE_ENV === 'production' && <Analytics />}</body></html>; }
